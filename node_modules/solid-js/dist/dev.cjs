...
if (signals.DEV) {
  signals.DEV.diagnostics.setConsoleFooter(event => `[${event.code}] repair guide: node_modules/solid-js/skills/reactivity-diagnostics/SKILL.md`);
}
