 ...
 */
export declare function materializeContainerTrace(marker: {
...
export declare const createSignal: {
    ...
    <T>(fn: ComputeFunction<NoInfer<T>, T>, options: HydrationSignalOptions<T> & {
        loadingValue: T;
    }): Signal<T>;
 ...
 * @internal
 */
export declare const createErrorBoundary: <T, U>(fn: () => T, fallback: (error: Accessor<unknown>, reset: () => void) => U) => Accessor<T | U>;
/**
 ...
 */
export declare const createProjection: <T extends object = {}>(fn: (draft: T) => void | T | Promise<void | T> | AsyncIterable<void | T>, initialValue: Partial<T> | Store<NoFn<T>>, options?: HydrationProjectionOptions) => Refreshable<Store<T>>;
...
export declare const createStore: {
    <T extends object = {}>(store: NoFn<T> | Store<NoFn<T>>, options?: {
        name?: string;
        shallow?: boolean;
